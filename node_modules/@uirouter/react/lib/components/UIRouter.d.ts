...
import { UIRouter as _UIRouter, UIRouterPlugin, PluginFactory } from '@uirouter/core';
 ...
 * ```
 */
export declare const UIRouterContext: React.Context<_UIRouter>;
/** @deprecated use [[useRouter]] or React.useContext(UIRouterContext) */
export declare const UIRouterConsumer: React.Consumer<_UIRouter>;
 ...
 * ```
 */
export declare function UIRouter(props: UIRouterProps): JSX.Element;
