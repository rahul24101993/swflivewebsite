 ...
 */
function useSrefActiveExact(stateName, params, activeClass, options) {
    if (params === void 0) { params = {}; }
    if (options === void 0) { options = {}; }
    var _a = useSref_1.useSref(stateName, params, options), href = _a.href, onClick = _a.onClick;
    var isActive = useIsActive_1.useIsActive(stateName, params, true);
    var className = isActive ? activeClass : '';
    return { href: href, onClick: onClick, className: className };
}
exports.useSrefActiveExact = useSrefActiveExact;
//# sourceMappingURL=useSrefActiveExact.js.map