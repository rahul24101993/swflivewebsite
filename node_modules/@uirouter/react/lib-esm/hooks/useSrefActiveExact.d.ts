 ...
 */
export declare function useSrefActiveExact(stateName: string, params: object, activeClass: string, options?: TransitionOptions): ActiveLinkProps;
export {};
