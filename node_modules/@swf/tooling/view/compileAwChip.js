...
const compile = ( node, context ) => {
    ...
    // old way
    // <aw-chip chip="xxx" action="xxx" button-type="xxx" ui-icon-action="xxx">
    //     </XXX>
    // </aw-chip>

    // new way
    // <AwChip chip= {xxx} action={actions.xxx} buttonType={xxx} uiIconAction={xxx} chipCondition={ {conditions} }>
    //      </XXX>
    // </AwChip>
